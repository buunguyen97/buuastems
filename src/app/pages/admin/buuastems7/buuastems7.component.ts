...
@Component({
    selector: 'app-buuastems7',
    templateUrl: './buuastems7.component.html',
    styleUrls: ['./buuastems7.component.scss']
})

export class Buuastems7Component implements OnInit, AfterViewInit {
