...
@Component({
    selector: 'app-buuastems11',
    templateUrl: './buuastems11.component.html',
    styleUrls: ['./buuastems11.component.scss']
})

export class Buuastems11Component implements OnInit, AfterViewInit {
