...
import {DxButtonComponent, DxDataGridComponent, DxMapComponent, DxPopupComponent} from "devextreme-angular";
import {CommonUtilService} from "../../../shared/services/common-util.service";
import {CommonCodeService} from "../../../shared/services/common-code.service";
import {PrecardService} from "../../mm/precard/precard.service";
import {GridUtilService} from "../../../shared/services/grid-util.service";
import _ from "lodash";

@Component({
    selector: 'app-buuastems1',
    templateUrl: './buuastems1.component.html',
    styleUrls: ['./buuastems1.component.scss']
})

export class Buuastems1Component implements OnInit, AfterViewInit {
    ...
    initMap(): void {
        ...
        this.sMap.zoom = 17;
        this.sMap.height = '800px ';
        this.sMap.width = '100%';

        this.sMap.markers = [{
            location: [10.7870676, 106.707627],
            // tooltip: {
            //   isShown: true,
            //   text:'test'
            // },
