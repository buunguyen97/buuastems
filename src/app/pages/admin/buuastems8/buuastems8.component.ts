...
@Component({
    selector: 'app-buuastems8',
    templateUrl: './buuastems8.component.html',
    styleUrls: ['./buuastems8.component.scss']
})

export class Buuastems8Component implements OnInit, AfterViewInit {
