...
@Component({
    selector: 'app-buuastems6',
    templateUrl: './buuastems6.component.html',
    styleUrls: ['./buuastems6.component.scss']
})
export class Buuastems6Component implements OnInit, AfterViewInit {
