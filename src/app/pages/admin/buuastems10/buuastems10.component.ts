...
@Component({
    selector: 'app-buuastems10',
    templateUrl: './buuastems10.component.html',
    styleUrls: ['./buuastems10.component.scss']
})
export class Buuastems10Component implements OnInit, AfterViewInit {
