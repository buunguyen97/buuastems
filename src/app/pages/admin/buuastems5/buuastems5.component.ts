...
import {DxButtonComponent, DxDataGridComponent, DxPopupComponent, DxDataGridModule} from "devextreme-angular";
...
@Component({
    selector: 'app-buuastems5',
    templateUrl: './buuastems5.component.html',
    styleUrls: ['./buuastems5.component.scss']
})

export class Buuastems5Component implements OnInit, AfterViewInit {
